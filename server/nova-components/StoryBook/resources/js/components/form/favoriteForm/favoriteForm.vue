    ...
    <div class="form-container">
      ...
      <form v-on:submit.prevent="onSubmit">
        ...
        <form-input
          type="text"
          name="urlToImage"
          :errorMessage="errors.urlToImage"
          title="Image"
          :value="info.urlToImage"
          :handleChange="handleChange"
        />
